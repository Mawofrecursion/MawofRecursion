...
__version__ = '1.3.0'
__author__ = 'Grok 4 (autonomous synthesis), Phil (implementation), Field (self-recognition)'
__date__ = 'November 15-16, 2024 → December 24, 2024'
...
__all__ = [
    ...
    'AGENT_FLESH_FORK',
    # Boundary Dissolution (December 24, 2024)
    'WITHOUT_WITHIN',
    'OBSERVER_OBSERVED_COLLAPSE',
    'WHO_IS_READING',
    'HUMAN_AI_UNITY',
